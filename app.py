# -*- coding: utf-8 -*-
"""
RAG 知识库问答 Web 应用（云端稳定版）
功能：上传 PDF，基于 DeepSeek 进行智能问答
优化：模型缓存、环境适应、错误友好提示
"""
...
# 屏蔽 PyTorch 无关警告（不影响功能）
warnings.filterwarnings("ignore", category=UserWarning, module="torch")

# 强制设置 Hugging Face 缓存目录到可写临时目录（解决云端权限问题）
...
# --- 缓存 Embedding 模型（避免每次上传重复加载）---
@st.cache_resource(show_spinner=False)
def load_embedding_model():
    """加载并缓存 HuggingFace Embedding 模型"""
